...
export default function Favourite() {
    ...
    // Sample favourite internships (replace with real data from state/db later)
    const favouriteInternships = [
        {
            id: 2,
    ...
    // Apply same filters like in Home
    const filteredInternships = favouriteInternships.filter(internship => {
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
                        Your Favourite Internships
                    </h1>
                    <p className="text-gray-600 dark:text-gray-400">
                        Internships you have saved for later
                    </p>
                </div>
                ...
                {filteredInternships.length === 0 && (
                    <div className="text-center py-12">
                        <div className="inline-flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 p-4 mb-4">
                            <FaHeart className="text-gray-500 dark:text-gray-400 text-2xl" />
                        </div>
                        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No favourites yet</h3>
                        <p className="text-gray-500 dark:text-gray-400">Save internships to view them here</p>
                    </div>
                )}
            </div>
        </div>
